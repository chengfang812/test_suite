...
login_list = [login_ip, 5979, 'bzl_user2', 'ss1234567']  # 账号密码正确
...
class ApiTest(unittest.TestCase):
    ...
    AGVManager.setAGVIPPort(login_list[0], login_list[1])
    AGVManager.connectRobot()  # 连接机器人
    time.sleep(0.5)
    AGVManager.loginRobot(login_list[2], login_list[3])  # 登录机器人
    ...
    #     self.assertEqual(getattr(Res, 'RESPONSE'), item[1])
    #
    def test_setInitPos(self, item):  # 设置初始点
