...
data_list = [
    ['192.168.1.11', 5979, 'bzl_user', 'ss1234567', False],  # IP错误
    ['192.168.1.110', 597, 'bzl_user', 'ss1234567', False],  # 端口错误
    ['192.168.1.110', 5979, 'bzl_user', 'ss12345678', True],  # IP、端口正确
]
login_list = [
    ['192.168.1.110', 5979, 'bzl212', 'ss1234567', False],  # 账号错误
    ['192.168.1.110', 5979, 'bzl_user', 'ss123456789', False],  # 密码错误
    ['192.168.1.110', 5979, '', 'ss123456789', False],  # 账号为空
    ['192.168.1.110', 5979, 'bzl_user', '', False],  # 密码为空
    ['192.168.1.110', 5979, 'bzl_user', 'ss1234567', True],  # 账号密码正确
]
