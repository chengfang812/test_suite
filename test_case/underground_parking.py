...
import sys,os
print(os.getcwd())
sys.path.append(r"E:/自动化/机器人接口测试/bros导航/untitled")
...
def test():
    jpype.startJVM(jpype.getDefaultJVMPath(), "-ea", r"-Djava.class.path=E:\自动化\机器人接口测试\bros导航\untitled\BaseAGV-2.3.1.jar")  # 启动jvm
