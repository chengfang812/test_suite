...
class Listener:
    ...
    def ros_communication_response_Data(self, s):
        ...
        # 地面抹平
        if getattr(Res, 'start_listener') and json.load(str(s))["cmd_type"] == 1000:
            data = json.loads(str(s)).get('data')
            setattr(Res, 'data', data[-1]['result'])
            setattr(Res, 'start_listener', False)
...
def test():
    ...
    while True:
        ...
        #     print(getattr(Res, 'response'))
        ...
        elif input_text == "90001":  # 参数设置数据获取
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":9000, "data":{}}')
            time.sleep(1)
            assert_fun(0)
        elif input_text == "90002":  # 参数设置数据获取-cmd_type为字符串
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":"9000", "seq_cmd":9000, "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90003":  # 参数设置数据获取-cmd_type浮点数
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000.0, "seq_cmd":9000, "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90004":  # 参数设置数据获取-cmd_type为None
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":None, "seq_cmd":9000, "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90005":  # 参数设置数据获取-cmd_type为""
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":"", "seq_cmd":9000, "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90006":  # 参数设置数据获取-cmd_type参数缺失
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"seq_cmd":9000, "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90007":  # 参数设置数据获取-seq_cmd为字符创
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":"9000", "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90008":  # 参数设置数据获取-seq_cmd为字符串
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":"9000", "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90009":  # 参数设置数据获取-seq_cmd为""
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":"", "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900010":  # 参数设置数据获取-seq_cmd为None
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":None, "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900011":  # 参数设置数据获取-seq_cmd缺失
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000,  "data":{}}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900012":  # 参数设置数据获取-data为字符串
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":9000, "data":"test"')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900013":  # 参数设置数据获取-data为""
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":9000, "data":""')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900014":  # 参数设置数据获取-data为None
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":9000, "data":None')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900015":  # 参数设置数据获取-data为缺失
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":9000, "seq_cmd":9000')
            time.sleep(1)
            assert_fun(1)

        elif input_text == "100001":  # 上装模式切换为作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10001, "seq_cmd":10001, "data":{}}')  # 先切回普通模式
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')
            time.sleep(1)
            assert_fun(0)

        elif input_text == "100002":  # 上装作业模式切换为作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')
            time.sleep(1)
        ...
        elif input_text == "100011":  # 上装作业模式切换为普通模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 先切回作业模式
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10001, "seq_cmd":10001, "data":{}}')
            time.sleep(1)
            assert_fun(0)
        elif input_text == "100012":  # 上装普通模式切换为普通模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10001, "seq_cmd":10001, "data":{}}')
            time.sleep(1)
        ...
        elif input_text == "100031":  # 作业模式 机器开始作业
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10003, "seq_cmd":10003, "data":{}}')  # 开始作业
            time.sleep(1)
            assert_fun(0)
            setattr(Res, 'start_listener', True)
            time.sleep(10)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10004, "seq_cmd":10004, "data":{}}')  # 停止作业
            time.sleep(1)
            assert_fun(0)

        elif input_text == "100032":  # 作业模式 开始振捣
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10005, "seq_cmd":10005, "data":{}}')  # 开始振捣
            time.sleep(1)
            assert_fun(0)

        elif input_text == "100033":  # 作业模式 开始作业 停止振捣
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10005, "seq_cmd":10005, "data":{}}')  # 开始作业
            time.sleep(1)
            assert_fun(0)
            setattr(Res, 'start_listener', True)
            time.sleep(10)
            ...
            assert_fun(0)
            setattr(Res, 'start_listener', True)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10006, "seq_cmd":10006, "data":{}}')  # 停止振捣
            time.sleep(1)
            assert_fun(1)

        elif input_text == "100034":  # 作业模式 停止作业   不是用例
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10004, "seq_cmd":10004, "data":{}}')  # 停止作业

        elif input_text == "100035":  # 作业模式 激光自动关闭
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10004, "seq_cmd":10004, "data":{}}')  # 激光自动关闭
            time.sleep(1)
            assert_fun(0)
        elif input_text == "100036":  # 作业模式 左推杆上
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10009, "seq_cmd":10009, "data":{}}')  # 左推杆上
            time.sleep(1)
            assert_fun(1)

        elif input_text == "100037":  # 作业模式 左推杆下
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10010, "seq_cmd":10010, "data":{}}')  # 左推杆下
            time.sleep(1)
            assert_fun(1)

        elif input_text == "100038":  # 作业模式 右推杆上
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10011, "seq_cmd":10011, "data":{}}')  # 右推杆上
            time.sleep(1)
            assert_fun(1)
        elif input_text == "100039":  # 作业模式 右推杆下
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10012, "seq_cmd":10012, "data":{}}')  # 右推杆下
            time.sleep(1)
            assert_fun(1)

        elif input_text == "1000310":  # 作业模式 左右推杆上
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10013, "seq_cmd":10013, "data":{}}')  # 右推杆上
            time.sleep(1)
            assert_fun(1)
        elif input_text == "1000311":  # 作业模式 左右推杆下
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10014, "seq_cmd":10014, "data":{}}')  # 右推杆下
            time.sleep(1)
            assert_fun(1)
        elif input_text == "1000312":  # 作业模式 振捣开启
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10017, "seq_cmd":10017, "data":{}}')  # 振捣开启
            time.sleep(10)
            assert_fun(1)
        elif input_text == "1000313":  # 作业模式-开始作业-振捣关闭
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10003, "seq_cmd":10003, "data":{}}')  # 开始作业
            time.sleep(10)
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10018, "seq_cmd":10018, "data":{}}')  # 振捣关闭
            time.sleep(1)
            assert_fun(1)



        elif input_text == "100032":  # 普通模式 机器开始作业
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10001, "seq_cmd":10001, "data":{}}')  # 普通模式
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10003, "seq_cmd":10003, "data":{}}')  # 开始作业
            time.sleep(1)
            assert_fun(1)
        ...
        elif input_text == "100032":  # 作业过程中切换为普通模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10000, "seq_cmd":10000, "data":{}}')  # 作业模式
            time.sleep(1)
        ...
        elif input_text == "100033":  # 停止作业  # 不是用例
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10004, "seq_cmd":10004, "data":{}}')

        elif input_text == "100051":  # 普通模式 开始振捣  停止振捣
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10001, "seq_cmd":10001, "data":{}}')  # 切换为普通模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10005, "seq_cmd":10005, "data":{}}')  # 开始振捣
            time.sleep(10)
            ...
            time.sleep(1)
            assert_fun(0)
        elif input_text == "100052":  # 振捣时改为作业模式
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10001, "seq_cmd":10001, "data":{}}')  # 切换为普通模式
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10005, "seq_cmd":10005, "data":{}}')  # 开始振捣
            time.sleep(10)
            setattr(Res, 'start_listener', True)
        ...
        elif input_text == "100053":  # 停止振捣  # 不是用例
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10004, "seq_cmd":10004, "data":{}}')

        elif input_text == "100070":  # 普通模式 激光自动开启 关闭
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10001, "seq_cmd":10001, "data":{}}')  # 切换为普通模式
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10007, "seq_cmd":10007, "data":{}}')  # 激光自动开启
            time.sleep(5)
            assert_fun(0)
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10008, "seq_cmd":10008, "data":{}}')  # 激光自动关闭
            time.sleep(10)
            assert_fun(1)

        elif input_text == "100081":  # 激光自动关闭 左推杆上
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10008, "seq_cmd":10008, "data":{}}')  # 激光自动关闭
            time.sleep(2)
            ...
            setattr(Res, 'start_listener', True)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":10100,"data":{"cancel_cmd":10009},"seq_cmd":1,"version":0}')  # 取消上装
            time.sleep(0.5)
            assert_fun(0)

        elif input_text == "100082":  # 激光自动关闭 左推杆下
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10008, "seq_cmd":10008, "data":{}}')  # 激光自动关闭
            time.sleep(2)
            ...
            setattr(Res, 'start_listener', True)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":10100,"data":{"cancel_cmd":10010},"seq_cmd":1,"version":0}')  # 取消上装
            time.sleep(0.5)
            assert_fun(0)

        elif input_text == "100083":  # 激光自动关闭 右推杆上
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10008, "seq_cmd":10008, "data":{}}')  # 激光自动关闭
            time.sleep(2)
            ...
            setattr(Res, 'start_listener', True)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":10100,"data":{"cancel_cmd":10011},"seq_cmd":1,"version":0}')  # 取消上装
            time.sleep(0.5)
            assert_fun(0)
        elif input_text == "100084":  # 激光自动关闭 右推杆下
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10008, "seq_cmd":10008, "data":{}}')  # 激光自动关闭
            time.sleep(2)
            ...
            setattr(Res, 'start_listener', True)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":10100,"data":{"cancel_cmd":10012},"seq_cmd":1,"version":0}')  # 取消上装
            time.sleep(0.5)
            assert_fun(0)

        elif input_text == "100085":  # 激光自动关闭 左右推杆上
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10008, "seq_cmd":10008, "data":{}}')  # 激光自动关闭
            time.sleep(2)
            ...
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10013, "seq_cmd":10013, "data":{}}')  # 右推杆下
            time.sleep(0.5)
            assert_fun(0)
            setattr(Res, 'start_listener', True)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":10100,"data":{"cancel_cmd":10013},"seq_cmd":1,"version":0}')  # 取消上装
            time.sleep(0.5)
            assert_fun(0)

        elif input_text == "100086":  # 激光自动关闭 左右推杆下
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10008, "seq_cmd":10008, "data":{}}')  # 激光自动关闭
            time.sleep(2)
            ...
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10014, "seq_cmd":10014, "data":{}}')  # 左右推杆下
            time.sleep(0.5)
            assert_fun(0)
            setattr(Res, 'start_listener', True)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":10100,"data":{"cancel_cmd":10014},"seq_cmd":1,"version":0}')  # 取消上装
            time.sleep(0.5)
            assert_fun(0)

        elif input_text == "100071":  # 激光自动开启 左推杆上
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10007, "seq_cmd":10007, "data":{}}')  # 激光自动开启
            time.sleep(2)
        ...
        elif input_text == "100072":  # 激光自动开启 左推杆下
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10007, "seq_cmd":10007, "data":{}}')  # 激光自动开启
            time.sleep(2)
        ...
        elif input_text == "100073":  # 激光自动开启 右推杆上
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10007, "seq_cmd":10007, "data":{}}')  # 激光自动开启
            time.sleep(2)
            ...
            time.sleep(0.5)
            assert_fun(0)
        elif input_text == "100074":  # 激光自动开启 右推杆下
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10007, "seq_cmd":10007, "data":{}}')  # 激光自动开启
            time.sleep(2)
        ...
        elif input_text == "100075":  # 激光自动开启 左右推杆上
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10007, "seq_cmd":10007, "data":{}}')  # 激光自动开启
            time.sleep(2)
        ...
        elif input_text == "100076":  # 激光自动开启 左右推杆下
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10007, "seq_cmd":10007, "data":{}}')  # 激光自动开启
            time.sleep(2)
            ...
            time.sleep(0.5)
            assert_fun(0)
        elif input_text == "100171":  # 振捣开启   确认在什么模式下开启
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData('{"cmd_type":10017, "seq_cmd":10017, "data":{}}')  # 振捣开启
            time.sleep(10)
        ...
        elif input_text == "90011":  # 振捣频率设置-数值在区间内
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(0)
        elif input_text == "90012":  # 振捣频率设置-数值等于最小值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":1000},"seq_cmd":1,"version":0}')
        ...
        elif input_text == "90013":  # 振捣频率设置-数值等于最大值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(0)
        elif input_text == "90014":  # 振捣频率设置-数值小于最小值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90015":  # 振捣频率设置-数值大于最大值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":1000},"seq_cmd":1,"version":0}')
        ...
        elif input_text == "90016":  # 振捣频率设置-数值为字符串
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":"1000"},"seq_cmd":1,"version":0}')
        ...
        elif input_text == "90017":  # 振捣频率设置-数值为浮点数
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90018":  # 振捣频率设置-数值为""
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90019":  # 振捣频率设置-数值为None
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":None},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900110":  # 振捣频率设置-数值缺失
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9001,"data":{"value":None},"seq_cmd":1,"version":0}')
        ...
        elif input_text == "90021":  # 水平高度设置-数值在区间内
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(0)
        elif input_text == "90022":  # 水平高度设置-数值等于最小值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":1000},"seq_cmd":1,"version":0}')
        ...
        elif input_text == "90023":  # 水平高度设置-数值等于最大值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(0)
        elif input_text == "90024":  # 水平高度设置-数值小于最小值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":1000},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90025":  # 水平高度设置-数值大于最大值
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":1000},"seq_cmd":1,"version":0}')
        ...
        elif input_text == "90026":  # 水平高度设置-数值为字符串
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":"1000"},"seq_cmd":1,"version":0}')
        ...
        elif input_text == "90027":  # 水平高度设置-数值为浮点数
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":1000.0},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90028":  # 水平高度设置-数值为""
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":""},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "90029":  # 水平高度设置-数值为None
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{"value":None},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
        elif input_text == "900210":  # 水平高度设置-数值缺失
            setattr(Res, 'start_listener', True)
            time.sleep(1)
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type":9002,"data":{},"seq_cmd":1,"version":0}')
            time.sleep(1)
            assert_fun(1)
...
def assert_fun(result1):
    data = getattr(Res, "data")
    print("recv_data:" + str(data))
    if data == result1:
        result = "断言成功"
    else:
        result = "断言失败"
