...
def test():
    ...
    while True:
        ...
        if input_text == '1':  # 单轴控制-MotorId参数为""
            ...
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, -200, 400, 1500, 2000, 100, 100, 100]}, "seq_cmd": 151, "version": "0.0"}')
        elif input_text == '152':  # 组合控制-喷平面启动-喷涂开始行程-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 0, 400, 1500, 2000, 100, 100, 100]}, "seq_cmd": 152, "version": "0.0"}')
        elif input_text == '153':  # 组合控制-喷平面启动-喷涂开始行程-参数为正常值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2000, 100, 100, 100]}, "seq_cmd": 153, "version": "0.0"}')
        elif input_text == '154':  # 组合控制-喷平面启动-喷涂开始行程-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 600, 400, 1500, 2000, 100, 100, 100]}, "seq_cmd": 154, "version": "0.0"}')
        elif input_text == '155':  # 组合控制-喷平面启动-喷涂开始行程-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 800, 400, 1500, 2000, 100, 100, 100]}, "seq_cmd": 155, "version": "0.0"}')
        elif input_text == '156':  # 组合控制-喷平面启动-喷涂结束行程-参数为小于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, -200, 1500, 2000, 100, 100, 100]}, "seq_cmd": 156, "version": "0.0"}')
        elif input_text == '157':  # 组合控制-喷平面启动-喷涂结束行程-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 0, 1500, 2000, 100, 100, 100]}, "seq_cmd": 157, "version": "0.0"}')
        elif input_text == '158':  # 组合控制-喷平面启动-喷涂结束行程-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 600, 1500, 2000, 100, 100, 100]}, "seq_cmd": 158, "version": "0.0"}')
        elif input_text == '159':  # 组合控制-喷平面启动-喷涂结束行程-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 800, 1500, 2000, 100, 100, 100]}, "seq_cmd": 159, "version": "0.0"}')
        elif input_text == '160':  # 组合控制-喷平面启动-起始高度-参数为小于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, -200, 2000, 100, 100, 100]}, "seq_cmd": 160, "version": "0.0"}')
        elif input_text == '161':  # 组合控制-喷平面启动-起始高度-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 0, 2000, 100, 100, 100]}, "seq_cmd": 161, "version": "0.0"}')
        elif input_text == '162':  # 组合控制-喷平面启动-起始高度-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 2500, 2000, 100, 100, 100]}, "seq_cmd": 162, "version": "0.0"}')
        elif input_text == '163':  # 组合控制-喷平面启动-起始高度-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 3000, 2000, 100, 100, 100]}, "seq_cmd": 163, "version": "0.0"}')
        elif input_text == '164':  # 组合控制-喷平面启动-结束高度-参数为小于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, -200, 100, 100, 100]}, "seq_cmd": 164, "version": "0.0"}')
        elif input_text == '165':  # 组合控制-喷平面启动-结束高度-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 0, 100, 100, 100]}, "seq_cmd": 165, "version": "0.0"}')
        elif input_text == '166':  # 组合控制-喷平面启动-结束高度-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 100, 100]}, "seq_cmd": 166, "version": "0.0"}')
        elif input_text == '167':  # 组合控制-喷平面启动-结束高度-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 3000, 100, 100, 100]}, "seq_cmd": 167, "version": "0.0"}')
        elif input_text == '168':  # 组合控制-喷平面启动-喷涂厚度-上-参数为小于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, -50, 100, 100]}, "seq_cmd": 168, "version": "0.0"}')
        elif input_text == '169':  # 组合控制-喷平面启动-喷涂厚度-上-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 0, 100, 100]}, "seq_cmd": 169, "version": "0.0"}')
        elif input_text == '170':  # 组合控制-喷平面启动-喷涂厚度-上-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 200, 100, 100]}, "seq_cmd": 170, "version": "0.0"}')
        elif input_text == '171':  # 组合控制-喷平面启动-喷涂厚度-上-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 250, 100, 100]}, "seq_cmd": 171, "version": "0.0"}')
        elif input_text == '172':  # 组合控制-喷平面启动-喷涂厚度-中-参数为小于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, -50, 100]}, "seq_cmd": 172, "version": "0.0"}')
        elif input_text == '173':  # 组合控制-喷平面启动-喷涂厚度-中-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 0, 100]}, "seq_cmd": 173, "version": "0.0"}')
        elif input_text == '174':  # 组合控制-喷平面启动-喷涂厚度-中-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 200, 100]}, "seq_cmd": 174, "version": "0.0"}')
        elif input_text == '175':  # 组合控制-喷平面启动-喷涂厚度-中-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 250, 100]}, "seq_cmd": 175, "version": "0.0"}')
        elif input_text == '176':  # 组合控制-喷平面启动-喷涂厚度-下-参数为小于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 100, -50]}, "seq_cmd": 176, "version": "0.0"}')
        elif input_text == '177':  # 组合控制-喷平面启动-喷涂厚度-下-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 100, 0]}, "seq_cmd": 177, "version": "0.0"}')
        elif input_text == '178':  # 组合控制-喷平面启动-喷涂厚度-下-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 100, 200]}, "seq_cmd": 178, "version": "0.0"}')
        elif input_text == '179':  # 组合控制-喷平面启动-喷涂厚度-下-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [1, 200, 400, 1500, 2500, 100, 100, 250]}, "seq_cmd": 179, "version": "0.0"}')
            ...
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [4, 1500, 3000, 0, 0, 10, 0, 0]}, "seq_cmd": 191, "version": "0.0"}')
        elif input_text == '192':  # 组合控制-喷左阳角启动-喷涂厚度-参数为小于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [4, 1500, 3000, 0, 0, 2, 0, 0]}, "seq_cmd": 192, "version": "0.0"}')
        elif input_text == '193':  # 组合控制-喷左阳角启动-喷涂厚度-参数为等于最小值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [4, 1500, 3000, 0, 0, 5, 0, 0]}, "seq_cmd": 193, "version": "0.0"}')
        elif input_text == '194':  # 组合控制-喷左阳角启动-喷涂厚度-参数为等于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [4, 1500, 3000, 0, 0, 30, 0, 0]}, "seq_cmd": 194, "version": "0.0"}')
        elif input_text == '195':  # 组合控制-喷左阳角启动-喷涂厚度-参数为大于最大值
            AGVManager.sendRosCommunicationRequestData(
                '{"cmd_type": 14100, "data": {"action": 3, "Value": [4, 1500, 3000, 0, 0, 35, 0, 0]}, "seq_cmd": 195, "version": "0.0"}')
